...
grid.arrange(summary_2.1$g_WAIFW, grey_actual_WAIFW, ncol = 2)

```

```{r g_comparison_SIR_dis_2_days, fig.height = 2.5, fig.align = 'center'}
...
### 2.2.4 Incidence goodness of fit
