...
summary_2.1 <- summarise_results(stan_fit_2.1, conceptual_matrix_A, 
...
summary_2.2 <- summarise_results(stan_fit_2.2, conceptual_matrix_B, 
                        output_gsi$incidence_df, output_sp$syn_pop$syn_pop,
...
summary_2.3 <- summarise_results(stan_fit_2.3, conceptual_matrix_C, 
                        output_gsi$incidence_df, output_sp$syn_pop$syn_pop,
