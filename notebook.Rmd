...
```{r loadReadSDr}
source("../../R_Packages/readsdr/R/generate_deSolve_components.R")
source("../../R_Packages/readsdr/R/generate_igraph_inputs.R")
source("../../R_Packages/readsdr/R/xmile_helpers.R")
source("../../R_Packages/readsdr/R/create_stan_function.R")
source("../../R_Packages/readsdr/R/read_xmile.R")
source("../../R_Packages/readsdr/R/arrange_variables.R")
source("../../R_Packages/readsdr/R/extract_variables.R")
```
...
# Fit and sample from the posterior
stan_fit_2.4 <- stan(fit = test, data = stan_d, chains = 3, warmup = 2000,
                 iter   = 4000, cores  = 3, seed = 1099652217, refresh = 2)
```
