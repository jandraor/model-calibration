...
specs_list <- list(x_pos = 1.36, ypos_mean = 100, ypos_median = 93, 
...
specs_list <- list(x_pos = 1.78, ypos_mean = 18, ypos_median = 17, 
                   text_size = 2, ypos_interval = 16, 
...
specs_list <- list(x_pos = 1.349, ypos_mean = 70, ypos_median = 65, 
                   text_size = 2, ypos_interval = 60, 
